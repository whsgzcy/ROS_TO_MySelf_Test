...
import com.jilk.ros.message.MessageDetails;
import com.jilk.ros.message.Nodes;
import com.jilk.ros.message.Services;
import com.jilk.ros.message.Topic;
import com.jilk.ros.message.Topics;
import com.jilk.ros.message.Type;
import com.jilk.ros.message.TypeDef;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<com.jilk.ros.message.Service, Type> serviceTypeService =
                new Service<com.jilk.ros.message.Service, Type>("/rosapi/service_type",
                        com.jilk.ros.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.jilk.ros.message.Service(service)).type;
    }
