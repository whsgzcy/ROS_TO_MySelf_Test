...
import com.jilk.ros.message.GetTime;
        ...
        try {
            ...
            Service<com.jilk.ros.message.Service, Type> serviceTypeService =
                    new Service<com.jilk.ros.message.Service, Type>("/rosapi/service_type",
                        com.jilk.ros.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(new com.jilk.ros.message.Service("/rosapi/service_response_details")).type;
